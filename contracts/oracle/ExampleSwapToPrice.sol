...
contract ExampleSwapToPrice {
    ...
    constructor(address factory_, ITWAMM twamm_) public {
        factory = factory_;
        twamm = twamm_;
    }
    ...
    function swapToPrice(
        ...
        uint256 amountIn;
        {
            ...
            (aToB, amountIn) = LiquidityMathLibrary
        ...
        TransferHelper.safeApprove(tokenIn, address(twamm), amountIn);

        address[] memory path = new address[](2);
        path[0] = tokenIn;
        path[1] = tokenOut;

        twamm.swapExactTokensForTokens(
            amountIn,
