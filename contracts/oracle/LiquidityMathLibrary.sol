...
library LiquidityMathLibrary {
    ...
    function getReservesAfterArbitrage(
        ...
        (reserveA, reserveB) = Library.getReserves(factory, tokenA, tokenB);

        require(
            reserveA > 0 && reserveB > 0,
            "ArbitrageLibrary: ZERO_PAIR_RESERVES"
        );
    ...
    function getLiquidityValue(
        ...
        (uint256 reservesA, uint256 reservesB) = Library.getReserves(
            factory,
            tokenA,
            tokenB
        );
        IPair pair = IPair(Library.pairFor(factory, tokenA, tokenB));
