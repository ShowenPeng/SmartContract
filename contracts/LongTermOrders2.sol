...
library LongTermOrdersLib {
        ...
        )
    {
        ...
        //when both pools sell, we use the TWAMM formula
            ...
            int256 endB = PRBMath.mulDivSigned(aStart, bStart, endA);
    ...
    function computeAmmEndTokenA(
        ...
        int256 eDenominator = PRBMath.mulDivSigned(
            PRBMathSD59x18.fromInt(1),
            PRBMathSD59x18.fromInt(1),
            aStart.sqrt().mul(bStart.sqrt())
        );
        ...
        int256 fraction = PRBMath.mulDivSigned(
            (exponent + c),
            PRBMathSD59x18.fromInt(1),
            (exponent - c)
        );
        ...
        int256 scaling = PRBMath.mulDivSigned(
            k,
            tokenAIn.sqrt(),
            tokenBIn.sqrt()
        );
